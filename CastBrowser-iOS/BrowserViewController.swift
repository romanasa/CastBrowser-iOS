...
class BrowserViewController: UIViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        super.viewWillAppear(animated)
            ...
            if sessionManager == nil {
                ...
                // Even if sessionManager exists, ensure discovery manager listener is added
                let discoveryManager = GCKCastContext.sharedInstance().discoveryManager
                discoveryManager.remove(self)  // Remove first to avoid duplicates
    ...
    private func setupUI() {
        ...
        NSLayoutConstraint.activate([
            ...
            addressBar.trailingAnchor.constraint(
                equalTo: view.trailingAnchor, constant: trailingConstant),
    ...
    private func setupWebView() {
            ...
            DispatchQueue.main.asyncAfter(deadline: .now() + 0.5) { [weak self] in
                ...
                do {
                    ...
                    if let button = self.castButton, let addressBar = self.addressBar {
                        ...
                        print(
                            "❌ Fallback Cast button creation also failed - trying navigation bar approach"
                        )
        ...
        private func addCastButtonToNavigationBar() {
            ...
            DispatchQueue.main.asyncAfter(deadline: .now() + 0.5) { [weak self] in
                guard let self = self else { return }
                do {
                    let navCastButton = GCKUICastButton(
                ...
                if testButton1 != nil {
                    ...
                    if let addressBar = self.addressBar {
                        NSLayoutConstraint.activate([
                            ...
                            testButton1.trailingAnchor.constraint(
                                equalTo: self.view.trailingAnchor, constant: -16),
                ...
                if testButton2 != nil {
                    ...
                    if let addressBar = self.addressBar {
                        NSLayoutConstraint.activate([
                            ...
                            testButton2.trailingAnchor.constraint(
                                equalTo: self.view.trailingAnchor, constant: -16),
        ...
        private func setupSessionManager() {
            ...
            print(
                "Discovery manager listener added. Discovery state: \(discoveryManager.discoveryState.rawValue)"
            )
            print("Discovery manager has passive scan: \(discoveryManager.hasDiscoveredDevices)")
        ...
        private func startCastDiscovery() {
            ...
            print("Passive scan enabled: \(discoveryManager.passiveScan)")
            print("Has discovered devices: \(discoveryManager.hasDiscoveredDevices)")

            // Enable passive scan for better discovery
            ...
            if discoveryManager.discoveryState != .running {
                ...
                // Force stop and restart to ensure discovery is working
            ...
            if discoveryStatusTimer == nil {
                discoveryStatusTimer = Timer.scheduledTimer(withTimeInterval: 5.0, repeats: true) {
                    [weak self] timer in
        ...
        private func updateDiscoveryStatus() {
            ...
            print(
                "Updating discovery status - Device count: \(deviceCount), Discovery state: \(discoveryManager.discoveryState.rawValue)"
            )
    ...
    private func setupNavigationBar() {
        ...
        #if !targetEnvironment(simulator) || !arch(x86_64)
            let castVideoButton = UIBarButtonItem(
                title: "Cast Video", style: .plain, target: self, action: #selector(manualCastVideo)
            )
        ...
        private func createCustomCastButton() {
            ...
            customCastButton.addTarget(
                self, action: #selector(customCastButtonTapped), for: .touchUpInside)
            ...
            if let addressBar = addressBar {
                NSLayoutConstraint.activate([
                    ...
                    customCastButton.trailingAnchor.constraint(
                        equalTo: view.trailingAnchor, constant: -16),
            ...
            if objc_getAssociatedObject(self, "customCastButton") == nil {
                objc_setAssociatedObject(
                    self, "customCastButton", customCastButton, .OBJC_ASSOCIATION_RETAIN_NONATOMIC)
            }
        ...
        @objc private func customCastButtonTapped() {
            ...
            if discoveryManager.deviceCount == 0 {
                showAlert(
                    ...
                    message:
                        "No Chromecast devices found on your network. Make sure your Chromecast is connected to the same Wi-Fi network as your device."
                )
                return
            }
        ...
        private func showCastDeviceList() {
            ...
            let alert = UIAlertController(
                title: "Select Cast Device", message: "Choose a Chromecast device to connect to:",
    ...
    @objc private func manualCastVideo() {
            ...
            guard let sessionManager = sessionManager,
                sessionManager.currentCastSession != nil
            else {
                showAlert(
                    title: "Connect to Chromecast",
                    message:
                        "Please connect to a Chromecast device first by tapping the Cast button (⎘) in the top-right corner."
                )
                return
            }
            ...
            showAlert(
                ...
                message:
                    "Casting is not available on the simulator. Please test on a physical device.")
        #endif
    }
        ...
        private func detectAndCastVideo() {
            ...
            webView.evaluateJavaScript(javascript) { [weak self] (result, error) in
                ...
                if let error = error {
                    ...
                    self.showAlert(
                        title: "Script Error",
                        message: "Error detecting video: \(error.localizedDescription)")
                    return
                }
        ...
        private func castVideo(url: String) {
            ...
            guard let session = currentSessionManager.currentCastSession else {
                showAlert(
                    title: "Cast Error",
                    message:
                        "No active Cast session found. Please connect to a Chromecast device first by tapping the Cast button."
                )
                return
            }
            ...
            guard let remoteMediaClient = session.remoteMediaClient else {
                showAlert(
                    title: "Cast Error",
                    message: "Cast session is not ready for media playback. Please try again.")
                return
            }
            ...
            let streamType: GCKMediaStreamType =
                url.contains(".m3u8") || url.contains("manifest") ? .live : .buffered
            ...
            showAlert(
                ...
                message:
                    "Attempting to cast video to your Chromecast device.\n\nURL: \(url)\nType: \(contentType)"
            )
        }
    ...
    extension BrowserViewController: GCKSessionManagerListener {
        ...
        func sessionManager(_ sessionManager: GCKSessionManager, didStart session: GCKSession) {
            ...
            showAlert(
                ...
                message:
                    "Connected to Cast device. Tap the Cast button (⎘) to cast video content from the current page."
            )
        ...
        func sessionManager(
            _ sessionManager: GCKSessionManager, didFailToStart session: GCKSession,
            withError error: Error
        ) {
            print("Failed to start cast session: \(error)")
            showAlert(
                title: "Cast Error",
                message: "Failed to start casting session: \(error.localizedDescription)")
        }
    }
    ...
    extension BrowserViewController: GCKRequestDelegate {
        ...
        func request(_ request: GCKRequest, didFailWithError error: GCKError) {
            ...
            showAlert(
                title: "Cast Error", message: "Failed to cast video: \(error.localizedDescription)")
        }
    }
    ...
    extension BrowserViewController: GCKDiscoveryManagerListener {
        ...
        func didInsert(_ device: GCKDevice, at index: UInt) {
            ...
            DispatchQueue.main.async {
                self.showAlert(
                    title: "Cast Device Found",
                    message: "Found Chromecast: \(device.friendlyName ?? "Unknown Device")")
                self.updateDiscoveryStatus()
            }
        }
...
extension BrowserViewController: WKNavigationDelegate {
    ...
    func webView(_ webView: WKWebView, didFinish navigation: WKNavigation!) {
        ...
        private func injectVideoDetectionHelper() {
            ...
            guard let webView = webView, let url = webView.url,
    ...
    func webView(_ webView: WKWebView, didFail navigation: WKNavigation!, withError error: Error) {
        showAlert(
            title: "Loading Error", message: "Failed to load page: \(error.localizedDescription)")
    }
}
